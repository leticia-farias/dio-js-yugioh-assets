...
const cardData = [
    {
        id: 0,
        name: "Paper",
        type: "Covers Rock, disproves Spock",
    ...
    },
    {
        id: 1,
        name: "Rock",
        type: "Crushes Lizard, and as it always has, crushes Scissors",
    ...
    },
    {
        id: 2,
        name: "Scissors",
        type: "Cuts Paper, decapitates Lizard",
    ...
    },
    {
        id: 3,
        name: "Lizard",
        type: "Poisons Spock, eats Paper",
        img: `${pathImages}lizard.png`,
        winOf: [0, 4],
        loseOf: [1, 2],
    },
    {
        id: 4,
        name: "Spock",
        type: "Smashes Scissors, vaporizes Rock",
        img: `${pathImages}spock.png`,
        winOf: [1, 2],
        loseOf: [0, 3],
    },
];
